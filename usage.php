...
$match1 = $NullCrypt->HashCompare($encrypted,$given1,$secretkey,$rounds);
$match2 = $NullCrypt->HashCompare($encrypted,$given2,$secretkey,$rounds);

// Two ways to process the returned result
$match1 = ($match1) ? 'True' : 'False';
echo "Match1: ".$match1."<br>";
